 ...
 * game.
 * 
 * @author Gaganjeet Singh. Pretty much all the code in here is from James Spargo, taken from class webpage.
 *
 */
...
public class GameBoard 
{
    ...
    //simply prints the score of the current game for both player
    public void printScores() {
    	System.out.println( "Score: Player 1 = " + this.getScore( 1 ) +
				", Player2 = " + this.getScore( 2 ) + "\n " );
    }
    /**
